...
//		icon: new L.Icon.Default(),
		icon: new L.LetterIcon(document.querySelectorAll('.leaflet-marker-icon').length),
		repeatMode: false,
...
//		var marker = new L.Marker(this._marker.getLatLng(), { icon: this.options.icon });
		var marker = new L.Marker(this._marker.getLatLng(), { icon: new L.LetterIcon(document.querySelectorAll('.leaflet-marker-icon').length - 1) });
